/**
  ...
  * @brief      MS4525 Airspeed Sensor Driver
...
static bool PIOS_MS4525_Read(uint8_t * buffer, uint8_t len)
{
	...
	return PIOS_I2C_Transfer(PIOS_I2C_MS4525_ADAPTER, txn_list, NELEMENTS(txn_list));
}
...
int16_t PIOS_MS4525_ReadAirspeed (void)
{
	...
	if (PIOS_MS4525_Read(airspeed_raw, sizeof(airspeed_raw)) != 0) {
